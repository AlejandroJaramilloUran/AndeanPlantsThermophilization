...
This page includes the code used to calculate the **community temperature score (CTS)** (the average of the thermal optima of species in a plot) using \~18 years iof tree plot data. The CTS is an index and its positive change over time is referred to as thermophilization. A positive change indicates an increase in the relative abundance of lowland species.
